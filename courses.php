...
use report_usercoursecompletions\reportbuilder\local\systemreports\course_report;
...
echo $OUTPUT->header();    
echo $OUTPUT->heading( get_string('coursereportheading', utils::get_plugin_name() ) );    
    
// Create out report instance, setting initial filtering if required.    
$report = system_report_factory::create(course_report::class, context_system::instance());    
